...
public class GIFWriter extends Terminator {
	private String filename;
	private int width,height;
	
	public GIFWriter(){
		super();
		name = "GIF File Writer Class";
	...
	public void Process(){
		...
		try {
			ImageIO.write(innerImage, "gif", new File(filename));
		} catch (Exception e) {
			System.out.println("Error in GIFWriter");
			System.exit(0);
		}
