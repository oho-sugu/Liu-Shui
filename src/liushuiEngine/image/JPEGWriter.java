...
public class JPEGWriter extends Terminator {
	private String filename;
	private int width,height;
	
	public JPEGWriter(){
		super();
		name = "JPEG File Writer Class";
	...
	public void Process(){
		...
		try {
			ImageIO.write(innerImage, "jpeg", new File(filename));
		} catch (Exception e) {
			System.out.println("Error in JPEGWriter");
			System.exit(0);
		}
